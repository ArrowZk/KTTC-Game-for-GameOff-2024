...
@export var dialogue_resource : DialogueResource = preload("res://Dialogues/lvl1_d1.dialogue")
...
func _ready() -> void:
	...
	RenderingServer.set_default_clear_color(Color("#022b3a"))
...
func _on_timer_timeout() -> void:
	$Extras/AudioStreamPlayer2D.play()
